...
class OrgsSearch extends GetView {
  OrgsSearch({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      ()=> ListView.builder(
          ...
          itemCount: searchController!.orgList.length > 5 ? 5:searchController!.orgList.length,
                          ...
                          Row(
                            children: [
                              searchController!.orgList[index].profile !=
                                  null
                                  ? CachedNetworkImage(
                                imageUrl: "${searchController!.userProfilePath.value}${searchController!.orgList[index].profile}",
                                ...
                                child: Center(
                                  child: Text(searchController!.orgList[index].fullname![0].toUpperCase(),
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                    searchController!.orgList[index].fullname ?? "",
                                    style: size12_M_bold(
                                        textColor: Colors.black),
                                  ),
                                  getSizedBox(h: 2),
                                  Text(
                                    searchController!.orgList[index].category!.join(','),
                    ...
                    InkWell(
                      onTap: () {
                        if (searchController!
                            ...
                            null && searchController!
                            .orgList[index].amIRequested == 0) {
                          ...
                          Api.delete.call(
                            context,
                            method: "organization-member/delete/${searchController!.orgList[index].amIJoined!.sId}",
                            param: {
                            },
                            onResponseSuccess: (object) {
                              AcceptUserDetail user =
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          searchController!.orgList[index].amIJoined == null &&
                              searchController!.orgList[index].amIRequested == 0 &&
                              searchController!.orgList[index].sId !=
                              ...
                              searchController!.orgList[index].sId !=
                                  AppPreference().getString(
                                      PreferencesKey.orgUserId)?"Leave Org" :searchController!.orgList[index].sId !=
                              AppPreference().getString(
                                  PreferencesKey.orgUserId)?"Join Req Sent":"",
                          style: size12_M_normal(
