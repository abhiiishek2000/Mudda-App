...
class OtherOrgMembersScreen extends GetView {
  OtherOrgMembersScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(
          ...
          child: orgMemberController!.memberList.isNotEmpty
              ? ListView(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                          onTap: () {
                            if (userDetail!.amIJoined == null &&
                                userDetail!.amIRequested == 0) {
                              AcceptUserDetail user = userDetail!;
                              user.amIRequested = 1;
                              userDetail = user;
                              Api.post.call(
                                context,
                                ...
                                param: {
                                  ...
                                  "request_type": "join",
                                  "requestModalPath": orgMemberController!
                            ...
                            else if (userDetail!.amIJoined != null) {
                              if(userDetail!.amIJoined!.role?.toLowerCase() == 'co-founder' || userDetail!.amIJoined!.role?.toLowerCase() == 'full'|| userDetail!.amIJoined!.role?.toLowerCase() == 'admin'){
                                Map<String, String>? parameters = {
                                  "id": jsonEncode(
                                      userDetail!.sId)
                                };
                                Get.toNamed(RouteConstants.invitedOrgSearchScreen, parameters: parameters);
                              }
                              else {
                                Api.delete.call(
                                  context,
                                  method:
                                  "organization-member/delete/${userDetail!
                                      .amIJoined!.sId}",
                                  param: {},
                                  onResponseSuccess: (object) {},
                                );
                          ...
                          child: userDetail!.amIJoined == null &&
                              (userDetail!.amIRequested != null &&
                                  userDetail!.amIRequested == 0)
                              ? SvgPicture.asset(
                            "assets/svg/join.svg",
                          )
                              : userDetail!.amIJoined != null
                              && (userDetail!.amIJoined!.role?.toLowerCase()=='co-founder' || userDetail!.amIJoined!.role?.toLowerCase()=='full' ||userDetail!.amIJoined!.role?.toLowerCase()=='admin')?
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.center,
              ...
              Padding(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (followersContext, index2) {
                      int index = index2 + 1;
                      MemberModel member = orgMemberController!.memberList
                          .elementAt(index);
                    ...
                    onTap: () {
                      if (userDetail!.amIJoined == null &&
                        ...
                        Api.delete.call(
                          context,
                          method:
                          "organization-member/delete/${userDetail!.amIJoined!.sId}",
                          param: {},
                          onResponseSuccess: (object) {},
                        );
                      }
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        userDetail!.amIJoined !=
                            null && member.role?.toLowerCase() != 'creator' && (userDetail!.amIJoined!.role?.toLowerCase() == 'co-founder' || userDetail!.amIJoined!.role?.toLowerCase() == 'full') && member.user!.sId !=AppPreference().getString(PreferencesKey.userId)?
                        InkWell(
                          onTap: () {
                            showEditMemberDialogBox(
                                member, index);
