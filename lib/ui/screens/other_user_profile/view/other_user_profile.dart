...
class _OtherUserProfileScreenState extends State<OtherUserProfileScreen> {
  ...
  void initState() {
    ...
    activityPage = 1;
    surveyPage = 1;
    print("USER:::${Get.parameters['id'] ?? userDetail!.fullname}");
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          actions: [
            IconButton(
                onPressed: () async {
                  CreateMyDynamicLinksClass()
                      .createDynamicLink(
                          true, '/otherUserProfileScreen?id=${userDetail!.sId}')
                      .then((value) {
            ...
            IconButton(
                onPressed: () =>
                    reportUserDialog(context, "${userDetail!.sId}"),
                icon: SvgPicture.asset(AppIcons.icReport))
          ]),
      body: Obx(
        () => RefreshIndicator(
          onRefresh: () {
            ...
            child: Column(
              ...
              children: [
                ...
                Obx(() => muddaNewsController
                            .acceptUserDetail.value.isUserBlocked ==
                        false
                    ? Padding(
                          ...
                          children: [
                            orgBox(
                                ...
                                onTap: () {
                                  ...
                                  chatController?.userId = user.sId;
                                  chatController?.chatId = user.chatId;
                                  chatController?.userName = user.fullname;
                                  chatController?.profile = user.profile;
                                  chatController?.isUserBlock.value =
                                      user.isUserBlocked!;
                    ...
                    : Obx(() => muddaNewsController
                        ...
                        ? Center(
                            child: orgBox(
                                title: "Unblock",
                                icon: AppIcons.icUnblock,
                                onTap: () {
                                  _showUnBlockDialog(
                                          context, "${userDetail!.sId}")
                                      .then((value) =>
                ...
                Obx(() => profileController!.isTabSelected.value == 0
                    ? profileController!.isProfileMuddaLoading.value?Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 15),
                  child: Column(
                    children: List.generate(
                      4,
                        ...
                        child: Column(
                          children: List.generate(
                            ...
                            (index) {
                              ...
                              } else if (muddaPost.leaders!.isEmpty) {
                                created = "";
                              } else {
                                    ...
                                    Visibility(
                                      ...
                                      child: Row(
                                        children: [
                                          Expanded(
                                            child: Text(
                                              "${NumberFormat.compactCurrency(
                                                ...
                                                symbol:
                                                    '', // if you want to add currency symbol then pass that in this else leave it empty.
                                              ).format(muddaPost.totalVote ?? 0)} Interactions",
                                              style: GoogleFonts.nunitoSans(
                                                  fontSize:
                                                      ScreenUtil().setSp(12),
                                                  fontWeight: FontWeight.w400,
                                          ...
                                          if (muddaPost.support != null)
                                            Text(
                                              "${muddaPost.support != 0 ? ((muddaPost.support! * 100) / (muddaPost.totalVote ?? 0)).toStringAsFixed(2) : 0}% / ${NumberFormat.compactCurrency(
                                                decimalDigits: 0,
                                                symbol:
                                                    '', // if you want to add currency symbol then pass that in this else leave it empty.
                                          ...
                                          if (muddaPost.support != null)
                                            Text(
                                              "${muddaPost.support != 0 ? ((muddaPost.support! * 100) / (muddaPost.totalVote ?? 0)).toStringAsFixed(2) : 0}%",
                                              style: size09_M_bold(
  ...
  reportUserDialog(BuildContext context, String userId) {
                      ...
                      Obx(
                        () => !muddaNewsController
                            ...
                            ? commonPostText(
                                ...
                                size: 13,
                                onPressed: () {
                                  _showBlockDialog(context, userId).then(
                                      (value) =>
                                          {Navigator.pop(context, value)});
                                })
                            : commonPostText(
                                ...
                                size: 13,
                                onPressed: () {
                                  _showUnBlockDialog(context, userId).then(
                                      (value) =>
                                          {Navigator.pop(context, value)});
                                }),
                      )
  ...
  Future<bool?> _showBlockDialog(BuildContext context, String userId) async {
    final muddaNewsController = Get.put(MuddaNewsController());
  ...
  _getProfile(BuildContext context, {bool isLoading = false}) async {
    ...
    Api.get.call(context,
        ...
        isLoading: isLoading, onResponseSuccess: (Map object) {
      print(object);
      userProfileUpdateController!.isLoading.value = false;
      var result = UserProfileModel.fromJson(object);
      userProfileUpdateController!.userProfilePath.value = result.path!;
      userProfileUpdateController!.userProfile.value = result.data!;
      muddaNewsController.acceptUserDetail.value = result.data!;
      userProfileUpdateController!.updateProfile.value =
