...
class UploadReplyScreen extends GetView {
  UploadReplyScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    postForMudda =
        PostForMudda.fromJson(jsonDecode(Get.parameters['postForMudda']!));
          ...
          children: [
            Padding(
              padding: const EdgeInsets.only(
                  left: 16, bottom: 12, right: 16, top: 24),
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      getSizedBox(h: ScreenUtil().setSp(12)),
                      Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text(TimeConvert.Dtime(postForMudda!.createdAt!)),
                          getSizedBox(w: ScreenUtil().setSp(30)),
                          Text(
                            "- ${postForMudda!.postAs == 'user' ? postForMudda!.userDetail!.fullname ?? '' : 'Anonymous'}",
                            style: size15_M_bold(textColor: Colors.black),
                          ),
                        ],
                      ),
...
class UploadChildReplyScreen extends GetView {
  UploadChildReplyScreen({Key? key}) : super(key: key);
  MuddaNewsController? muddaNewsController;
  PostForMudda? responseModelResult;
  final Trimmer _trimmer = Trimmer();
  int selectedIndex = 0;
  int rolePage = 1;
  ScrollController roleController = ScrollController();
                  ...
                  Column(
                    ...
                    children: [
                      Container(
                          width: Get.width / 1.4,
                          child: Text(
                            responseModelResult!.muddaDescription!,
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis,
                            style: size14_M_semiBold(
                              textColor: blackGray,
                      ...
                      Row(
                        ...
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text(TimeConvert.Dtime(
                              responseModelResult!.createdAt!)),
                          getSizedBox(w: ScreenUtil().setSp(30)),
                          Text(
                            "- ${responseModelResult!.userDetail!.fullname!}",
                            style: size15_M_bold(textColor: Colors.black),
                          ),
                        ],
                      ),
                ...
                GetStartedButton(
                  onTap: () async {
                    ...
                    FormData formData = FormData.fromMap({
                      ...
                      "user_id": _appPreference
                          .getString(PreferencesKey.interactUserId),
                      "parentId": responseModelResult!.sId
                    });
                    if (muddaNewsController!.postAnynymous.value) {
                      formData.fields
                          .add(const MapEntry("post_as", "anynymous"));
                    ...
                    Api.uploadPost.call(context,
                      ...
                      muddaNewsController!.postForMuddaList
                          .insert(0, PostForMudda.fromJson(object['data']));
                      Get.back();
                    });
                  },
                  title: "Post",
