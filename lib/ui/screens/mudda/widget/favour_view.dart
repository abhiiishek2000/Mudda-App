...
//
// class MuddaVideoBox extends StatefulWidget {
...
//
//   @override
//   State<MuddaVideoBox> createState() => _MuddaVideoBoxState();
// }
//
// class _MuddaVideoBoxState extends State<MuddaVideoBox>
...
//               margin:
//               const EdgeInsets.only(top: 24, bottom: 4, right: 8, left: 40),
...
//                         ),
//                         // Container(
//                         //   margin: EdgeInsets.only(left: 16, top: 5, bottom: 8),
//                         //   child: Text(
//                         //     "@ramu kaka, @ramesh singh, @kuwar kukra, @ponga ram, @Ramkoaku rawala",
//                         //     overflow: TextOverflow.ellipsis,
//                         //     maxLines: 1,
                ...
                children: [
                  Container(
                    ...
                    margin: const EdgeInsets.only(
                        top: 0, bottom: 4, right: 8, left: 28),
                    // decoration: BoxDecoration(
                    ...
                    //       ? Border.all(
                    //       color: const Color(0xffA0A0A0).withOpacity(0.50), width: 0.5)
                    //       : null,
                    // ),
                    child: Column(
                      children: [
                        ...
                        if (widget.postForMudda.parentPost != null) ...[
                          // SlideTransition(
                          //   position: offset,
                          //   child: Container(height: 40,width: 100,color: Colors.blueAccent),
                          // ),
                          ...
                          isFullPostShow
                              ...
                              : Padding(
                                  padding: const EdgeInsets.only(
                                      left: 0, top: 8, bottom: 8, right: 64),
                                  child: InkWell(
                                    onTap: () {
                                      isFullPostShow = true;
                                      setState(() {});
