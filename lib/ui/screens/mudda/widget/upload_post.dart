...
class UploadPostScreen extends GetView {
  ...
  Widget build(BuildContext context) {
    ...
    if (muddaNewsController?.muddaPost.value.isInvolved != null) {
      if (muddaNewsController?.muddaPost.value.isInvolved!.joinerType ==
              "creator" ||
      ...
      } else if (muddaNewsController?.muddaPost.value.isInvolved!.joinerType ==
          "opposition") {
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Obx(
              () => Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      "max ${900 - muddaNewsController!.descriptionValue.value.length} characters",
            ...
            Obx(
              () => Row(
                children: [
                  Expanded(
                    child: Row(
                      children: [
                        ...
                        InkWell(
                          onTap: () {
                            muddaNewsController!.postAnynymous.value =
                                !muddaNewsController!.postAnynymous.value;
                          },
                          child: Row(
                            children: [
                  ...
                  Expanded(
                    child: Visibility(
                      visible: muddaNewsController!.uploadRoleList.isNotEmpty,
                      child: InkWell(
                        onTap: () {
            ...
            getSizedBox(h: 20),
            Obx(() => muddaNewsController?.muddaPost.value.isInvolved != null
                ? const SizedBox()
                : Container(
                    height: 1,
                    color: Colors.black,
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                              ...
                              child: Row(
                                children: [
                                  Container(
                                    height: 20,
                                    width: 20,
                                    child: muddaNewsController!.postIn.value ==
                                            "favour"
                                        ? const Center(
                                            child: CircleAvatar(
                                            radius: 5,
                            ...
                            InkWell(
                              onTap: () {
                                muddaNewsController!.postIn.value =
                                    "opposition";
                              },
                              child: Row(
                                children: [
                ...
                GetStartedButton(
                  onTap: () async {
                    ...
                    if (muddaNewsController!.postAnynymous.value) {
                      formData.fields
                          .add(const MapEntry("post_as", "anynymous"));
                    }
                    for (int i = 0;
                        i <
                    ...
                    // }
                    // log('${muddaNewsController!.uploadPhotoVideos.length}');
                  },
                  title: "Post",
                )
              ],
  ...
  _getRoles(BuildContext context) async {
    Api.get.call(context,
        ...
        param: {
          ...
          "interactModal": "CreatePost"
        },
        isLoading: true, onResponseSuccess: (Map object) {
      var result = UserRolesModel.fromJson(object);
      if (rolePage == 1) {
        muddaNewsController!.uploadRoleList.clear();
      }
      if (result.data!.isNotEmpty) {
        muddaNewsController!.roleProfilePath.value = result.path!;
        muddaNewsController!.uploadRoleList.addAll(result.data!);
        Role role = Role();
        role.user = User();
        ...
        muddaNewsController!.uploadRoleList.add(role);
      } else {
            ...
            child: Column(
              ...
              children: [
                ...
                ListView.builder(
                    ...
                    itemCount: muddaNewsController!.uploadRoleList.length,
                    itemBuilder: (followersContext, index) {
                      Role role = muddaNewsController!.uploadRoleList[index];
                      return InkWell(
                        onTap: () {
                    ...
                    try {
                      ...
                      if (pickedFile != null) {
                        _cropImage(File(pickedFile.path)).then((value) async {
                          ...
                          //           90, value, '${value.path}compressed.jpg')
                          //       .then((value) {
                  ...
                  try {
                    ...
                    if (pickedFile != null) {
                      _cropImage(File(pickedFile.path)).then((value) async {
                        ...
                        //           90, value, '${value.path}compressed.jpg')
                        //       .then((value) {
                        //     log('final size${value.lengthSync()}');
                        //     muddaNewsController!.uploadPhotoVideos.insert(
                        //         muddaNewsController!.uploadPhotoVideos.length -
                        //             1,
                        //         value.path);
                    ...
                    try {
                      ...
                      if (result != null) {
                        ...
                        if (filePath != null) {
                          ...
                          muddaNewsController!.trimmer
                              .loadVideo(videoFile: videoFile);
                          muddaNewsController!.uploadPhotoVideos.insert(
                              muddaNewsController!.uploadPhotoVideos.length - 1,
                              filePath);
