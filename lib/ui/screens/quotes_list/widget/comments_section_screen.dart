...
class CommentsSectionScreen extends StatefulWidget {
  const CommentsSectionScreen({Key? key}) : super(key: key);
...
class _CommentsSectionScreenState extends State<CommentsSectionScreen> {
  ...
  void initState() {
    ...
    profileController!.quotesOrActivity.value = Get.arguments;
    allQuotesScrollController.addListener(() {
      if (allQuotesScrollController.position.maxScrollExtent ==
          allQuotesScrollController.position.pixels) {
        allPage++;
        _allQuotes(context);
      }
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(
        () => RefreshIndicator(
          onRefresh: () {
            profileController!.reQuotePostList.clear();
            allPage = 1;
            return _allQuotes(context);
          },
          child: ListView.builder(
              controller: allQuotesScrollController,
              physics: const AlwaysScrollableScrollPhysics(),
              padding: EdgeInsets.only(bottom: ScreenUtil().setSp(70)),
              itemCount: profileController!.reQuotePostList.length + 1,
              itemBuilder: (followersContext, index) {
                Quote quote = index == 0
                    ? profileController!.quotesOrActivity.value
                    : profileController!.reQuotePostList.elementAt(index - 1);
                if (index == 0) {
                  return Container(
                    ...
                    child: Column(
                      children: [
                                      ...
                                      InkWell(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: CachedNetworkImage(
                                            height: ScreenUtil().setSp(177),
                                            width: ScreenUtil().screenWidth,
                                            imageUrl:
                                                "${profileController!.quotePostPath.value}${quote.gallery!.elementAt(0).file!}",
                                            fit: BoxFit.cover,
                                          ),
                                        ),
                                      )
                        ...
                        quote.postOf == "quote" && quote.gallery!.length > 1
                            ? SizedBox(
                                        ...
                                        child: GestureDetector(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: CachedNetworkImage(
                                              ...
                                              width: Get.width * 0.3,
                                              imageUrl:
                                                  "${profileController!.quotePostPath.value}${quote.gallery!.elementAt(index).file!}",
                                              fit: BoxFit.cover,
                                            ),
                                          ),
                                        ),
                            ...
                            : Container(),
                        getSizedBox(h: ScreenUtil().setSp(5)),
                        Padding(
                          padding: EdgeInsets.only(
                                    ...
                                    InkWell(
                                      onTap: () {
                                        if (quote.amILiked != null) {
                                          ...
                                          q.userId = AppPreference().getString(
                                                      ...
                                                      () => Padding(
                                                        ...
                                                        child: Row(
                                                          children: [
                                                            const Spacer(),
                                                            Text(
                                                              "remain ${300 - profileController!.descriptionValue.value.length} characters",
                                                            ...
                                                            itemBuilder:
                                                              ...
                                                              return Padding(
                                                                ...
                                                                child:
                                                                    GestureDetector(
                                                                  onTap: () {
                                                                    if ((profileController!.uploadPhotoVideos.length -
                                                                            index) ==
                                                                        1) {
                                                                      uploadPic(
                                                                          context);
                                                                  ...
                                                                  child: (profileController!.uploadPhotoVideos.length -
                                                                              index) ==
                                                                          1
                                                                      ? Container(
                                                                          height:
                                                                      ...
                                                                      : Container(
                                                                          ...
                                                                          child: profileController!.uploadPhotoVideos.elementAt(index).contains("Trimmer")
                                                                              ? Stack(
                                                                                  children: [
                                                                                    SizedBox(
                                                                                      height: 100,
                                                                              ...
                                                                              : Image.file(
                                                                                  File(profileController!.uploadPhotoVideos.elementAt(index)),
                                                                                  height: 100,
                                                                                  width: 100,
                                                                                ),
                                                                        ),
                                                          ...
                                                          child: Row(
                                                            children: [
                                                              ...
                                                              InkWell(
                                                                ...
                                                                child: Row(
                                                                  children: [
                                                                    profileController!.selectedRole.value.user !=
                                                                            null
                                                                        ? profileController!.selectedRole.value.user!.profile !=
                                                                                null
                                                                            ? CachedNetworkImage(
                                                                                imageUrl: "${profileController!.roleProfilePath.value}${profileController!.selectedRole.value.user!.profile}",
                                                                                imageBuilder: (context, imageProvider) => Container(
                                                                                  ...
                                                                                  decoration: BoxDecoration(
                                                                                    ...
                                                                                    borderRadius: BorderRadius.all(Radius.circular(ScreenUtil().setSp(15)) //                 <--- border radius here
                                                                                        ),
                                                                            ...
                                                                            : Container(
                                                                                ...
                                                                                child: Center(
                                                                                  child: Text(profileController!.selectedRole.value.user!.fullname![0].toUpperCase(), style: GoogleFonts.nunitoSans(fontWeight: FontWeight.w400, fontSize: ScreenUtil().setSp(16), color: black)),
                                                                                ),
                                                                              )
                                                                        : AppPreference().getString(PreferencesKey.profile).isNotEmpty
                                                                            ? CachedNetworkImage(
                                                                            ...
                                                                            : Container(
                                                                                ...
                                                                                child: Center(
                                                                                  child: Text(AppPreference().getString(PreferencesKey.fullName)[0].toUpperCase(), style: GoogleFonts.nunitoSans(fontWeight: FontWeight.w400, fontSize: ScreenUtil().setSp(16), color: black)),
                                                                                ),
                                                                              ),
                                                                    getSizedBox(
                                                                        w: 6),
                                                        ...
                                                        children: [
                                                          GetStartedButton(
                                                            onTap: () async {
                                                              ...
                                                              for (int i = 0;
                                                                  i <
                                                                      (profileController!.uploadPhotoVideos.length ==
                                                                              5
                                                                          ? 5
                                                                          : (profileController!.uploadPhotoVideos.length -
                                                                              1));
                                                                ...
                                                                formData.files
                                                                  ...
                                                                  MapEntry(
                                                                      ...
                                                                      await MultipartFile.fromFile(
                                                                          profileController!.uploadPhotoVideos[
                                                                              i],
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          onTap: () {
                                            ...
                                            int pIndex = index - 1;
                                            profileController!.reQuotePostList
                                                .removeAt(pIndex);
                                            profileController!.reQuotePostList
                                                .insert(pIndex, quote);
                                            Api.post.call(
                                                            ...
                                                            child: Row(
                                                              children: [
                                                                profileController!
                                                                    ...
                                                                    ? CachedNetworkImage(
                                                                  imageUrl:
                                                                  "${profileController!.roleProfilePath.value}${profileController!.selectedRole.value.user!.profile}",
                                                                  ...
                                                                  Center(
                                                                    child:
                                                                    Text(profileController!.selectedRole.value.user!.fullname![0].toUpperCase(), style: GoogleFonts.nunitoSans(fontWeight: FontWeight.w400, fontSize: ScreenUtil().setSp(16), color: black)),
                                                                  ),
                                                                )
                                                                    : AppPreference()
                                                                    .getString(
                                                                  ...
                                                                  Center(
                                                                    child:
                                                                    Text(AppPreference().getString(PreferencesKey.fullName)[0].toUpperCase(), style: GoogleFonts.nunitoSans(fontWeight: FontWeight.w400, fontSize: ScreenUtil().setSp(16), color: black)),
                                                                  ),
                                                                ),
                                                                getSizedBox(w: 6),
                                                                Text(
                              ...
                              Row(
                                children: [
                                  InkWell(
                                    onTap: () {
                                      Share.share(
                                        '${Const.shareUrl}${quote.postOf}/${quote.sId}',
                                      );
                                    },
                                    child: Padding(
                                      padding: const EdgeInsets.all(10),
  ...
  GestureDetector iconThreeDot(Quote quote) {
    return GestureDetector(
        onTap: () {
          reportQuotePostDialogBox(context, quote);
        },
  ...
  _allQuotes(BuildContext context) async {
    Api.get.call(context,
        ...
        param: {
          ...
          "parent_id": profileController!.quotesOrActivity.value.sId
        },
      ...
      if (result.data!.isNotEmpty) {
        ...
        profileController!.reQuotePostList.addAll(result.data!);
      } else {
